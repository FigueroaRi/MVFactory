...
using MVFactory.Services.WebApi.Helpers;
...
namespace MVFactory.Services.WebApi.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        private readonly IUsersApplicacion _usersApplication;
        private readonly AppSettings _appSettings;

        public UsersController(IUsersApplicacion authApplication, IOptions<AppSettings> appSettings)
        {
        ...
        /// <summary>
       /// Se usa metodo de autenticacion usando JSON WEB TOKEN(JWT)
        /// </summary>
        /// <returns></returns>
